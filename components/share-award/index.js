...
Component({
  ...
  methods: {
    ...
    drawImage: function () {
      ...
      ctx.drawImage(app.globalData.postcard_code_url, windowWidth * (0.5 - qrCodeWidthScale / 2), qrCodeHeightScale * windowHeight, qrCodeWidthScale * windowWidth, qrCodeWidthScale * windowWidth); 
